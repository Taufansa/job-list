...
<?php  $show  = new team('','','','','');
       $data_team = $show->getteam($_COOKIE['username']);
       if ($data_team['team'] == null) {
?>

  <div class="container" style="padding-top: 80px;">
      <H3>Please Join a Team Before</H3>
  </div>

<?php } else { ?>
<div class="container" style="padding-top: 80px;">
  <h4 class="text-center"><?= $data_team['team']; ?>'s Jobs</h4>
    <H3>Ongoing Jobs</H3>
    <ol>
        <?php 
            $team = $show->getteam($_COOKIE['username']);
            $team = $team['team'];
            //print_r($team);
            $data_table = $show->showteamjob($team,'Ongoing');
           //var_dump($data_table);
            //print_r($data_table);
...
<div class="container">
    ...
    <ol>
        <?php 
            ...
            $data_table = $show->showteamjob($team,'Outstanding');
            //print_r($data_table);
            foreach ($data_table as $data) { ?>
                <li>
                    <a href="update.php?id=<?= $data['number'];?>"><?= $data['title']; ?></a>
...
<div class="container" >
    ...
    <ol>
        <?php 
            ...
            $data_table = $show->showteamjob($team,'Finished');
            //print_r($data_table);
            foreach ($data_table as $data) { ?>
                <li>
                    <a href="update.php?id=<?= $data['number'];?>"><?= $data['title']; ?></a>
...
<div class="container">
    ...
    <ol>
        <?php 
            ...
            $data_table = $show->showteamjob($team,'Closed');
            //print_r($data_table);
            foreach ($data_table as $data) { ?>
                <li>
                    <a href="update.php?id=<?= $data['number'];?>"><?= $data['title']; ?></a>
